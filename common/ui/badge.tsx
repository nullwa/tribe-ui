...
// #region styles
const styles = cva(['group/badge flex items-center justify-center gap-1', 'font-medium whitespace-nowrap', 'select-none border', '[&_svg]:size-3.5 [&_svg]:shrink-0'], {
  variants: {
